...
test('UnorderedSet set() contains()', async (t) => {
  ...
  t.is(await unorderedSetContract.view('contains', { element: 'hello' }), false)
...
test('UnorderedSet insert, len and iterate', async (t) => {
  ...
  t.deepEqual(await unorderedSetContract.view('toArray', {}), ['hello', 'hello1'])
})
...
test('UnorderedSet extend, remove, clear', async (t) => {
  ...
  t.deepEqual(await unorderedSetContract.view('toArray', {}), ['hello', 'world', 'hello1'])
  ...
  t.deepEqual(await unorderedSetContract.view('toArray', {}), ['hello1', 'world'])
