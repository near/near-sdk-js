          ...
          for (let child of classNode.body.body) {
            if (
              ...
              if (child.decorators[0].expression.callee.name == "call") {
                ...
                child.decorators[0].expression.callee.name == "initialize"
              ) {
                  ...
                  t.blockStatement([
                    ...
                    t.variableDeclaration("let", [
                      t.variableDeclarator(
                        ...
                        t.callExpression(
                          t.memberExpression(classId, t.identifier("_create")),
                          []
                        )
                      ),
                    ]),
                      ...
                      t.ifStatement(
                        ...
                        t.expressionStatement(
                          t.callExpression(
                            t.memberExpression(
                              t.identifier("env"),
                              t.identifier("value_return")
                            ),
                            [
                              t.callExpression(
                                t.memberExpression(
                                  classId,
                                  t.identifier("_serialize")
                                ),
                                [t.identifier("_result")]
                              ),
                            ]
