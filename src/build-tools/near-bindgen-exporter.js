...
function throwError(message) {
  return t.blockStatement([t.throwStatement(t.newExpression(t.identifier('Error'), [t.stringLiteral(message)]))])
}
...
function readState(classId) {
  return t.variableDeclaration('const', [
    t.variableDeclarator(
      t.identifier('_state'),
      t.callExpression(t.memberExpression(classId, t.identifier('_getState')), [])
    ),
  ])
}
...
function ensureInitBeforeCall(classId, methodType) {
  ...
  return t.ifStatement(
    t.logicalExpression(
      ...
      t.callExpression(t.memberExpression(classId, t.identifier('_requireInit')), [])
    ),
  ...
  return t.ifStatement(
    ...
    t.blockStatement([
      t.expressionStatement(
        t.callExpression(t.memberExpression(classId, t.identifier('_reconstruct')), [
          t.identifier('_contract'),
          t.identifier('_state'),
        ])
      ),
...
function collectArguments(classId) {
  return t.variableDeclaration('const', [
    t.variableDeclarator(
      t.identifier('_args'),
      t.callExpression(t.memberExpression(classId, t.identifier('_getArgs')), [])
    ),
  ])
}
...
function callContractMethod(methodName) {
  return t.variableDeclaration('const', [
    t.variableDeclarator(
      ...
      t.callExpression(t.memberExpression(t.identifier('_contract'), t.identifier(methodName)), [t.identifier('_args')])
    ),
  ])
}
...
function saveToStorage(classId, methodType) {
  ...
  return t.expressionStatement(
    t.callExpression(t.memberExpression(classId, t.identifier('_saveToStorage')), [t.identifier('_contract')])
  )
}

function executePromise(classId) {
  return t.ifStatement(
    t.binaryExpression('!==', t.identifier('_result'), t.identifier('undefined')),
    t.ifStatement(
      t.logicalExpression(
        '&&',
        t.logicalExpression(
          '&&',
          t.identifier('_result'),
          t.memberExpression(t.identifier('_result'), t.identifier('constructor'))
        ),
        t.binaryExpression(
          '===',
          t.memberExpression(
      ...
      t.expressionStatement(
        t.callExpression(t.memberExpression(t.identifier('_result'), t.identifier('onReturn')), [])
      ),
      t.expressionStatement(
        t.callExpression(t.memberExpression(t.identifier('env'), t.identifier('value_return')), [
