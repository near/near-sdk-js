                        ...
                        path.insertAfter(t.exportNamedDeclaration(t.functionDeclaration(t.identifier(method), [], t.blockStatement([
                            ...
                            contractMethods[method] === "initialize"
                                ? // if (_state) { throw new Error('Contract already initialized'); }
                                    t.ifStatement(t.identifier("_state"), t.throwStatement(t.newExpression(t.identifier("Error"), [
                                        t.stringLiteral("Contract already initialized"),
                                    ])))
                                : t.emptyStatement(),
                            contractMethods[method] === "call" ||
                                contractMethods[method] === "view"
                                ? // if (!_state) { throw new Error('Contract must be initialized'); }
                                    t.ifStatement(t.logicalExpression("&&", t.unaryExpression("!", t.identifier("_state")), t.callExpression(t.memberExpression(classId, t.identifier("_requireInit")), [])), t.blockStatement([
                                        t.throwStatement(t.newExpression(t.identifier("Error"), [
                                            t.stringLiteral("Contract must be initialized"),
                                        ])),
                                    ]))
                                : t.emptyStatement(),
                            ...
                            contractMethods[method] === "call" ||
                                ...
                                ? // if (_state) { Object.assign(_contract, state); }
                                    t.ifStatement(t.identifier("_state"), t.blockStatement([
                                        t.expressionStatement(t.callExpression(t.memberExpression(classId, t.identifier("_reconstruct")), [
                            ...
                            t.variableDeclaration("let", [
                                t.variableDeclarator(t.identifier("_result"), t.callExpression(t.memberExpression(t.identifier("_contract"), t.identifier(method)), [t.identifier("_args")])),
                            ]),
                            contractMethods[method] === "initialize" ||
                                contractMethods[method] === "call"
