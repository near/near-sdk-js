...
export declare function promiseCreate(accountId: string, methodName: string, args: Bytes, amount: NearAmount, gas: NearAmount): bigint;
export declare function promiseThen(promiseIndex: PromiseIndex, accountId: string, methodName: string, args: Bytes, amount: NearAmount, gas: NearAmount): bigint;
...
export declare function promiseBatchThen(promiseIndex: PromiseIndex, accountId: string): bigint;
...
export declare function promiseBatchActionFunctionCall(promiseIndex: PromiseIndex, methodName: string, args: Bytes, amount: NearAmount, gas: NearAmount): void;
...
export declare function promiseBatchActionAddKeyWithFunctionCall(promiseIndex: PromiseIndex, publicKey: Bytes, nonce: number | bigint, allowance: NearAmount, receiverId: string, methodNames: string): void;
...
export declare function promiseBatchActionFunctionCallWeight(promiseIndex: PromiseIndex, methodName: string, args: Bytes, amount: NearAmount, gas: NearAmount, weight: number | bigint): void;
