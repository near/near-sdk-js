...
import { assert, serializeValueWithOptions, ERR_INCONSISTENT_STATE, concat, bytes } from "../utils";
...
export class UnorderedSet {
    ...
    contains(element, options) {
        const indexLookup = concat(this.elementIndexPrefix, serializeValueWithOptions(element, options));
    ...
    remove(element, options) {
        ...
        if (lastElement !== element) {
            const lastLookupElement = concat(this.elementIndexPrefix, serializeValueWithOptions(lastElement, options));
