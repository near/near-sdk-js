...
import { assert, serializeValueWithOptions, ERR_INCONSISTENT_STATE, u8ArrayConcat, latin1ToU8Array, } from "../utils";
...
export class UnorderedSet {
    ...
    contains(element, options) {
        const indexLookup = u8ArrayConcat(this.elementIndexPrefix, serializeValueWithOptions(element, options));
    ...
    remove(element, options) {
        ...
        if (lastElement !== element) {
            const lastLookupElement = u8ArrayConcat(this.elementIndexPrefix, serializeValueWithOptions(lastElement, options));
