import { assert, ERR_INCONSISTENT_STATE, getValueWithOptions, bytes, serializeValueWithOptions, concat, } from "../utils";
...
export class UnorderedMap {
    ...
    constructor(prefix) {
        this.prefix = prefix;
        this.keys = new Vector(concat(prefix, bytes("u"))); // intentional different prefix with old UnorderedMap
        this.values = new LookupMap(concat(prefix, bytes("m")));
    }
    /**
    ...
    static reconstruct(data) {
        ...
        map.values = new LookupMap(concat(data.prefix, bytes("m")));
        return map;
    }
}
/**
