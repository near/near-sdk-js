import { assert, ERR_INCONSISTENT_STATE, getValueWithOptions, latin1ToU8Array, serializeValueWithOptions, u8ArrayConcat, } from "../utils";
...
export class UnorderedMap {
    ...
    constructor(prefix) {
        this.prefix = prefix;
        this.keys = new Vector(u8ArrayConcat(prefix, latin1ToU8Array("u"))); // intentional different prefix with old UnorderedMap
        this.values = new LookupMap(u8ArrayConcat(prefix, latin1ToU8Array("m")));
    }
    /**
    ...
    static reconstruct(data) {
        ...
        map.values = new LookupMap(u8ArrayConcat(data.prefix, latin1ToU8Array("m")));
        return map;
    }
}
/**
