...
test.beforeEach(async t => {
    ...
    await counter.call(jsvm, 'call_js_contract', encodeCall(counter.accountId, 'init', []), {attachedDeposit: '800000000000000000000000'});
...
test('Increase works', async t => {
    ...
    await bob.call(jsvm, 'call_js_contract', encodeCall(counter.accountId, 'increase', [4]), {attachedDeposit: '100000000000000000000000'});
...
test('Decrease works', async t => {
    ...
    await bob.call(jsvm, 'call_js_contract', encodeCall(counter.accountId, 'decrease', [4]), {attachedDeposit: '100000000000000000000000'});
    result = await jsvm.view('view_js_contract', encodeCall(counter.accountId, 'getCount', []));
    t.is(result, -5);
});